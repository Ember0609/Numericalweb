...
export default function App() {
    ...
    const GraphicalCal = ({fx,xl,xr,et})=>{
        try {
            const cal = new Graphical(fx, xl, xr, et);
            const res = cal.solve();
    ...
    return (
        <Box p={6} bg="gray.700" minW="100vw" minH="100vh">
                    <VStack spacing={4}>
                        <Heading color={"white"}>Graphical Methods</Heading>
                        <Center>
                            <XLRform onCalculate={GraphicalCal} />
                        </Center>
